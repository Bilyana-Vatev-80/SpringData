...
import com.example.bookshopsystem.model.entities.*;
...
public class BookServiceImpl implements BookService {
    ...
    private static final String BOOKS_FILE_PATH = "Spring-Data-Intro-Exercise/BookShopSystem/src/main/resources/files/books.txt";

    public BookServiceImpl(BookRepository repository, BookRepository bookRepository, AuthorService authorService, CategoryService categoryService) {
    ...
    @Override
    public List<String> findAllAuthorsNamesWithReleaseDateBeforeYear(int year) {
    ...
    @Override
    public List<String> findAllBooksByFirstNameLastNameOrderByReleaseDate(String firstName, String lastName) {
